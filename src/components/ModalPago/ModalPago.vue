<template>
  ...
  <q-dialog v-model="internalValue" @blur="closeModal">
    <div class="modal-pago">
      ...
      <div class="modal-content">
        ...
        <div class="columna-izquierda">
          ...
          <!-- Espacio adicional debajo de las opciones de pago -->
          <div class="extra-space"></div>

          <!-- Formulario de tarjeta -->
          <q-input filled label="Nombre del titular" />
          <!-- Campo para nombre del titular de la tarjeta -->
          <q-input filled label="Número de la tarjeta" />
          <!-- Campo para número de la tarjeta -->
          <div class="card-info">
            <q-input filled label="Fecha" />
            <!-- Campo para fecha de expiración de la tarjeta -->
            <q-input filled label="CVV" />
            <!-- Campo para código de seguridad de la tarjeta -->
          </div>
        </div>
        ...
        <div class="columna-derecha">
          ...
          <!-- Botón de acción para realizar el pago -->
        </div>
      </div>
...
.modal-pago {
  ...
  .modal-content {
    ...
    .columna-izquierda {
      ...
      .extra-space {
        height: 20px; // Altura adicional para espaciado
      }
    }
  ...
  .card-info {
    display: flex; // Flexbox para organizar fecha y CVV en fila
